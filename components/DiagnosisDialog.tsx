...
import { diagnoseResume } from '../geminiService';
                    ...
                    <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
                        ...
                        <div className="space-y-4">
                            {result.issues.map((issue, idx) => (
                                <div key={idx} className="group p-5 bg-zinc-800/40 rounded-2xl border border-zinc-800 hover:border-zinc-700 transition-all">
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex-1 space-y-2">
                                            <div className="flex items-center justify-between">
                                                <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">{issue.module}</span>
